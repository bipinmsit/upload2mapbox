...
"""
Script to upload mapbox supported data as tilesets (Sequential)
Tileset id are only first 14 char length
...
def upload_to_mapbox(upload_dir):
    ...
    for file in os.listdir(upload_dir):
        ...
        service = Uploader()
        with open(os.path.join(os.path.abspath(upload_dir), file), "rb") as src:
